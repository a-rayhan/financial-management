...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://api-taupe-delta.vercel.app/api/user/update/${currentUser._id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      const res = await fetch(`https://api-taupe-delta.vercel.app/api/user/delete/${currentUser._id}`, {
        method: "DELETE",
      });
      const data = await res.json();
